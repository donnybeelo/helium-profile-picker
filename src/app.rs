        ...
        egui::CentralPanel::default()
            ...
            .show(ctx, |ui| {
                ...
                if let Some(copy_time) = self.copy_time {
                    ...
                    const OPAQUE_DURATION: f32 = 0.9;
                    const FADE_DURATION: f32 = 0.1;
                    const TOTAL_DURATION: f32 = OPAQUE_DURATION + FADE_DURATION;
                    ...
                    if elapsed < TOTAL_DURATION {
                        ...
                        let painter = ui.painter();
                        let al = (alpha * 255.0) as u8;
                        painter.rect_filled(toast_rect, CornerRadius::same(12), Color32::from_rgba_unmultiplied(50, 50, 50, al));
                        painter.rect_stroke(toast_rect, CornerRadius::same(12), 
                        ...
                        let stroke = Stroke::new(1.5, Color32::from_rgba_unmultiplied(255, 255, 255, al));
                        
                        let back_rect = egui::Rect::from_center_size(icon_center + egui::Vec2::new(-1.0, 1.0), egui::Vec2::splat(8.0));
                        painter.rect_stroke(back_rect, CornerRadius::same(1), stroke, StrokeKind::Outside);
                        
                        let front_rect = egui::Rect::from_center_size(icon_center + egui::Vec2::new(1.0, -1.0), egui::Vec2::splat(8.0));
                        painter.line_segment([front_rect.left_top(), front_rect.right_top()], stroke);
                        painter.line_segment([front_rect.right_top(), front_rect.right_bottom()], stroke);
                        
                        painter.text(egui::Pos2::new(toast_rect.center().x + 12.0, toast_rect.center().y),
                            egui::Align2::CENTER_CENTER, "Copied!", egui::FontId::proportional(13.0), Color32::from_rgba_unmultiplied(255, 255, 255, al));
